...
class chp_add_shortcode_button {

    var $pluginname = 'chp_shortcodes';
    var $path = '';
    ...
    function add_tinymce_langs_path($plugin_array) {
        ...
        $plugin_array[ $this->pluginname ] = $this->path . 'languages.php';
        return $plugin_array;
...
if ( is_admin() ) {
    ...
    $tinymce_button = new chp_add_shortcode_button();
